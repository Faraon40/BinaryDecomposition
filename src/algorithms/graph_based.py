...
Based on the flow-network approach to minimal rectangular partitioning of
digitized binary images described in:

- Ferrari, L., Sankar, P., & Sklansky, J. (1984). Minimal Rectangular
  Partitions of Digitized Blobs. Computer Vision, Graphics, and Image
  Processing, 28, 58–71. https://doi.org/10.1016/0734-189x(84)90139-7
- Suk, T., Höschl, C., & Flusser, J. (2012). Decomposition of binary
  images—A survey and comparison. Pattern Recognition, 45(12), 4279–4291.
  https://doi.org/10.1016/j.patcog.2012.05.012
"""
