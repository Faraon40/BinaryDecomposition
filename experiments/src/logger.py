...
class CSVLogger:
    ...
    csv/algorithm/dataset_name/results.csv
    ...
    def __init__(
        ...
        # Create hierarchical directory: csv/algorithm/dataset_name/
        self.output_dir = Path(output_dir) / algorithm_name / dataset_name
