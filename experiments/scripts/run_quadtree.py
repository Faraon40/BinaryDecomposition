"""Run Quadtree decomposition experiments on binary images.

This script runs the Quadtree decomposition algorithm on image directories
...
def save_solution_rectangles(
    ...
    save_dir = output_dir / "quadtree" / dataset_name / image_stem
...
def run_experiments(
    ...
    for i, img_path in enumerate(image_paths, 1):
        ...
        try:
            ...
            viz_subdir = viz_dir / "quadtree" / image_dir_name
